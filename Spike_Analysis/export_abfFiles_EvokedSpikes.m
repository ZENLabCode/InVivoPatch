...
files = 'X:\1 TIDIS Lab\Tiago\Ephys_PROCESSED\In_vivo\Awake_Sleep\PFC_Processed\20211015_TC_P037_Day2\Evoked_Spikes\*.abf.lnk';
...
for fil = 1:noFIL
    ...
    if strcmpi(rExt,'.lnk')
        ...
        rname = ['X:', rname(3:end)]; %alter to fit the mapping of the ZEN drive
